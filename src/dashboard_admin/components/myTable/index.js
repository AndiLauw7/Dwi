                ...
                <Col xs={dateRangePicker ? 5 : 12}>
                    <div className="d-flex justify-content-end  gap-3" >
                        ...
                        <InputGroup style={{ width: "300px" }}>
                            ...
                            />
                            {btnSearch ? (
                                <Button style={{ height: 40 }} variant="primary" id="search" onClick={handleSearch}>
                                    <RiSearch2Line />
                                </Button>
                            ) : (
                                <Button style={{ height: 40 }} variant="danger" id="search" onClick={handleClear}>
                                    <RiCloseLine />
                                </Button>
                            )}
                        ...
                        {pathAdd && (
                            <Button style={{ height: 40 }} variant="primary" id="search" onClick={() => navigate(pathAdd)}>
                                <RiAddLine /> Tambah
                            </Button>
                        )}
                    </div>
