...
export const TentangSekolah = () => {
  return (
    <div
      ...
      style={{ backgroundColor: "#007aff", borderRadius: "5px" }}
    >
      <Row>
        <Col md={6}>
          <div style={{ textAlign: "left", color: "white" }}>
            <h1>Visi dan Misi</h1> Unila telah menetapkan tekad untuk
            melanjutkan dharma membangun Unila dan bangsa secara bersama-sama.
            Dengan keteguhan hati, dalam Rencana Pembangunan Jangka Panjang
            (RPJP) Unila 2005-2025 telah ditetapkan visi Unila yaitu : <br />{" "}
            <br />
            ...
            kebijakan Kementerian Pendidikan dan Kebudayaan, Unila telah pula
            menetapkan misi dalam RPJP Unila 2005-2025, yaitu : <br /> <br />
            <h4>Misi Universitas Lampung Misi Unila</h4>
            seperti yang tertera di dalam dokumen RPJP 2005 – 2015 dan dokumen
            Renstra 2007 – 2011 sebagai berikut.Butir-butir Misi Unila yang
            telah disempurnakan sebagai berikut: <br />
            <ol>
              <li>
                {" "}
            ...
            <ol>
              <li>
                menghasilkan lulusan yang bermutu dan berdaya saing tinggi yang
            ...
            bangsa, seluruh keluarga besar Unila bersatu padu dalam mewujudkan
            visi dan misi Unila ini.
          </div>
        </Col>
        <Col md={6}>
          <img
